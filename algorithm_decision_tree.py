...
accuracy2 = DTAccuracy1(pred2, labels_test)
accuracy10 = DTAccuracy1(pred10, labels_test)
accuracy2_n = DTAccuracy1(pred2_n, labels_test_n)
accuracy10_n = DTAccuracy1(pred10_n, labels_test_n)
